...
void robotTask(void* p) {
  //skills start
    ...
    runIntake(600);
    runUptake(0);
    chassisController.toPoint({52.5,-20,convertToRadians(282)});
    pros::delay(10);
    newX.forwardVelocity(600,150);
    pros::delay(10);
    chassisController.toAngle(convertToRadians(5));
    pros::delay(10);
    chassisController.toPoint({69,-52,convertToRadians(5)});
    pros::delay(10000);
    ...
    runUptake(0);
    runIntake(0);
    chassisController.toPoint({80,-78.75,convertToRadians(0)});
    pros::delay(10);
    runIntake(600);
    newX.forwardVelocity(450,200);
    pros::delay(300);
    ...
    pros::delay(10);
    chassisController.toPoint({90,-84,convertToRadians(325)});
    runUptake(600);
    runIntake(200);
    newX.forwardVelocity(350,200);
    pros::delay(850);
    runUptake(0);
    runIntake(0);
    chassisController.toPoint({93,-81,convertToRadians(325)});
    pros::delay(10);
    chassisController.toAngle(convertToRadians(160));
    runIntake(600);
    pros::delay(250);
    chassisController.toPoint({43,-98,convertToRadians(240)});
    // +6,-11.5
